...
Notes--
      ...
      We want to again express our gratitude for allowing us to attempt these assignments in 
       an alternate JVM language, and by doing so, push the boundaries of our knowledge. We
       appreciate your patience in grading them, and your feedback during the semester. 


Usage--

      We have included a Java makefile for ease of use. Invoking "$ make" at the command line
       will compile the StudentSocketImpl.java, client3.java, and server3.java files- 
      ...
      As per the specifications, the two sides of the program should be invoked with "$ java 
       -DUDPPORT=8816 -DLOSSRATE=0.50 server3 8817" and "$ java -DUDPPORT=8816 -DLOSSRATE=0.50 
       client3 servermachinename 8817" respectively after compilation. We have tested our 
       program and expect it to work both with and without packet loss. 
